        ...
        <form action="{{route('question.store', ['quiz_id' => $q_id])}}" method="POST">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="post" name="description" rows="3">{{ $question->description }}</textarea>
                    @error('description')
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="isOpen" {{ $question->isOpen?'checked':'' }}>
