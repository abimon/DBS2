...
@section('content')
    <div class="container">
        <form action="{{route('module.store',['course_id'=>$id])}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                <div class="mb-3">
                    <label for="title" class="form-label"><b>Title</b></label>
                    <input type="text" class="form-control" id="title" name="title" required>
                    <small id="titleHelp" class="form-text text-muted">Enter the title of the module.</small>
                    @error('title')
