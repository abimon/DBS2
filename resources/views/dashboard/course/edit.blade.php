        ...
        <form action="{{route('course.update', $course->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <div class="ms-2 card p-3 border-dark bg-transparent shadow h-75" style="border-style:dashed;">
                            <img id="outCard" src="{{ $course->cover }}" style="height: 100%; object-fit:contain;" />
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            <label for="duration" class="form-label">Estimate Duration(Hrs)</label>
                            <input type="number" class="form-control" id="estimate_duration" value="{{ $course->estimate_duration }}" name="duration" required>
                            <small id="durationHelp" class="form-text text-muted">Enter the duration of the course in
                                hours.</small>
                            @error('estimate_duration')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="post" name="description" rows="3" >
                        {{ $course->description }}
                    </textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="mb-3">
                    <label for="objectives" class="form-label"><b>Curriculum</b></label>
                    <textarea class="form-control" id="objectives" name="curriculum" rows="3">
                        {{ $course->curriculum }}
                    </textarea>
                    @error('curriculum')
                        <span class="invalid-feedback" role="alert">
