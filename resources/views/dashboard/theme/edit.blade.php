@extends('layouts.app', ['title' => 'Create Theme'])
@section('content')
    <div class="container">
        <form action="{{route('theme.update',$theme->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="cover"><b>Theme Cover Photo</b></label>
                        <div class="ms-2 card p-3 border-dark bg-transparent shadow h-75" style="border-style:dashed;">
                            <img id="outCard" src="{{ $theme->cover }}" style="height: 100%; object-fit:contain;" />
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <small id="titleHelp" class="form-text text-muted">Enter the title of the theme.</small>
                            @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="post" name="description" rows="3" required>
                        {{ $theme->description }}
                    </textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
